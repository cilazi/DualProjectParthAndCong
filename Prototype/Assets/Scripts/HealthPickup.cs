...
public class HealthPickup : MonoBehaviour
{
	...
	void OnTriggerEnter2D (Collider2D other)
	{
		...
		if(other.tag == "Player")
		{
            ...
            playerHealth.anger = 100 - playerHealth.health;
            playerHealth.anger = Mathf.Clamp(playerHealth.anger, 0f, 100f);

			// Update the health bar.
			playerHealth.UpdateHealthBar();
            playerHealth.UpdateAngerBar();
            playerHealth.UpdateAbility();
